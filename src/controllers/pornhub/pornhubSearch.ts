import { scrapeContent } from "../../services/scrapers/pornhub/pornhubSearchController";
...
export async function searchPornhub(req: Request, res: Response) {
  try {
     ...
     * curl -i https://adultcolonyapi.site/pornhub/search?query=milf
     * curl -i https://adultcolonyapi.site/pornhub/search?query=milf&page=2&sort=mr
     *
     * @apiExample {js} JS/TS
     * import axios from "axios"
     *
     * axios.get("https://adultcolonyapi.site/pornhub/search?query=milf")
     ...
     *  async with session.get("https://adultcolonyapi.site/pornhub/search?query=milf") as resp:
