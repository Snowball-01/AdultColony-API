import { scrapeContent } from "../../services/scrapers/hentaifox/hentaifoxSearchController";
...
export async function searchHentaifox(req: Request, res: Response) {
  try {
     ...
     * curl -i https://adultcolonyapi.site/hentaifox/search?query=yuri
     * curl -i https://adultcolonyapi.site/hentaifox/search?query=yuri&page=2&sort=latest
     * 
     * @apiExample {js} JS/TS
     * import axios from "axios"
     * 
     * axios.get("https://adultcolonyapi.site/hentaifox/search?query=yuri")
     ...
     *  async with session.get("https://adultcolonyapi.site/hentaifox/search?query=yuri") as resp:
    ...
    const url = `${c.HENTAIFOX}/search/?q=${query}&sort=${sort}&page=${page}`;
