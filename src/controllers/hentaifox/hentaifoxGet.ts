import { scrapeContent } from "../../services/scrapers/hentaifox/hentaifoxGetController";
...
export async function getHentaifox(req: Request, res: Response) {
  try {
     ...
     * curl -i https://adultcolonyapi.site/hentaifox/get?book=123
     * 
     * @apiExample {js} JS/TS
     * import axios from "axios"
     * 
     * axios.get("https://adultcolonyapi.site/hentaifox/get?book=123")
     ...
     *  async with session.get("https://adultcolonyapi.site/hentaifox/get?book=123") as resp:
